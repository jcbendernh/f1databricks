...
To do so, clone this repo to your GitHub environment and add your cloned GitHub repo to your Databricks environment via Git Folders. For more on this topic, check out [Set up Databricks Git folders](https://learn.microsoft.com/en-us/azure/databricks/repos/repos-setup).
